<%-- 
    ...
    Created on : 5/10/2012, 03:44:47 PM
    Author     : cpu1
--%>
...
<table width="100%" height="100%" border="0" >
  ...
  <tr>
    ...
    <td width="77%"><p align="center">&nbsp;</p>
      <div id="apDiv2">
        <h2>Quienes somos </h2>
        <p class="Estilo6">Hospital Dental ofrece un tratamiento global y personalizado.</p>
        <p class="Estilo6">En el cual se tiene encuenta todos los factores que pueden intervenir en su problema bucodentario</p>
